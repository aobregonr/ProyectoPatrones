<<<<<<< HEAD:WebContent/views/permission.jsp
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <select class="form-control">
                                ...
                                <option>Half-Day permission</option>
                                <option>No-Salary permission</option>
                              </select>
                          </div>
                      </div>
                      <div class="form-group row">
                          <label for="inputName2" class="col-md-2 control-label">Days</label>
                          <div class="col-md-10">
                              <input type="number" class="form-control" id="inputName" placeholder="Days" min="1">
                            </div>
                        </div>
                        <a href="#" class="btn btn-primary btn-block"><b>Request</b></a>
                  </form>
                </div>
                <!-- /.card-body -->
              </div>
...
>>>>>>> master:WebContent/views/permissions.html
